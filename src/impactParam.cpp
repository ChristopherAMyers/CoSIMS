 ...
 *
 * using Cramer's Rule, solve linear systems of equations to solve for
...
void impactParam::setBoundry(double minKin)
{
	...
	*/
    ...
    vector3D<double> vel, pos;
    vector3D<double> prevPos, blank(0,0,0);		    //vectors for determining test points
